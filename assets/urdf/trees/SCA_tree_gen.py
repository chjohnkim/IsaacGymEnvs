...
class TreeGenerator(object):
    ...
    def generate_urdf(self):
        ...
        save_path_file = "%stree_%s.urdf" % (self.path, self.tree_id)
    ...
    def generate_yaml(self):
        ...
        location = "%stree_%s.yaml" % (self.path, self.tree_id)
...
tg = TreeGenerator(path='./', max_steps=10000, att_pts_max=100, da=50, dt=0.25, step_width=0.2, offset=[-0.5, -0.5, 0.25], scaling=5, max_tree_points=30, tip_radius=0.03, gui_on=1, z_strech=0.25, x_strech=2, y_strech=2)
tg.generate_tree()
